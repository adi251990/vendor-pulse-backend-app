...
import com.hireme.platform.common.exception.DomainExceptions.NoPaymentMethodException;
...
import com.hireme.platform.shift.dto.CreateShiftRequest;
import com.hireme.platform.shift.dto.ShiftResponse;
...
public class ShiftService {
    ...
    public ShiftResponse publish(UUID orgId, UUID shiftId) {
        ...
        if (shift.getStatus() != ShiftStatus.DRAFT) {
            throw new com.hireme.platform.common.exception.DomainExceptions.InvalidStateTransitionException(
