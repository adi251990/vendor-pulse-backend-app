package com.hireme.platform.notification.service;

import com.hireme.platform.booking.entity.Booking;
import com.hireme.platform.config.TwilioProperties;
...
public class NotificationService {
    ...
    public void notifyOwnerOfNoShow(Shift shift, Booking booking) {
        userRepository.findByOrgId(shift.getOrgId())
                .forEach(owner -> {
                    ...
                    sendSms(owner.getPhone(), "HireMe: no-show detected on \"" + shift.getTitle()
    ...
    public void notifyStaffOfBackupDispatch(Shift shift, Booking backupBooking) {
        userRepository.findById(backupBooking.getStaffId()).ifPresent((User staff) -> {
            ...
            sendSms(staff.getPhone(), "HireMe URGENT: \"" + shift.getTitle()
