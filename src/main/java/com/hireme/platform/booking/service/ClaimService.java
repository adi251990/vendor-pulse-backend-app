package com.hireme.platform.booking.service;
...
import com.hireme.platform.common.exception.DomainExceptions.ClaimFailedException;
import com.hireme.platform.common.exception.DomainExceptions.DuplicateResourceException;
import com.hireme.platform.common.exception.DomainExceptions.ResourceNotFoundException;
import com.hireme.platform.common.exception.DomainExceptions.ShiftAlreadyClaimedException;
import com.hireme.platform.common.exception.DomainExceptions.ShiftNotClaimableException;
import com.hireme.platform.common.exception.DomainExceptions.StaffNotEligibleException;
...
public class ClaimService {
    ...
    private ClaimResponse claimInTransaction(UUID shiftId, UUID staffId) {
        ...
        if (shift.getFilledCount() >= shift.getHeadcount()) {
            shift.setStatus(com.hireme.platform.shift.entity.ShiftStatus.FILLED);
        } else {
            shift.setStatus(com.hireme.platform.shift.entity.ShiftStatus.MATCHING);
        }
