package com.vendorpulse.platform.booking.repository;
...
public interface BookingRepository extends JpaRepository<Booking, UUID> {
    ...
    @org.springframework.data.jpa.repository.Query("""
            ...
            join com.vendorpulse.platform.shift.entity.Shift s on s.id = b.shiftId
            where b.status = 'CLAIMED'
              and s.startTime < :cutoff
              and not exists (
                  select 1 from com.vendorpulse.platform.attendance.entity.GeoLog g
